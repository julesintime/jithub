---
name: trigger-config
description: Complete guide to configuring Trigger.dev v4 trigger.config.ts with build extensions for databases (Prisma, TypeORM), scripting languages (Python), browser automation (Playwright, Puppeteer), media processing (FFmpeg), system packages (apt-get), environment syncing, custom extensions, telemetry, and machine/performance settings. Use when setting up trigger.config.ts, adding build extensions, configuring deployment environment, or customizing the build process.
---
