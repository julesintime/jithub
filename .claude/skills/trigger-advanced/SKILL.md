---
name: trigger-advanced
description: Advanced Trigger.dev v4 patterns including tags & organization, concurrency & queues, error handling & retries, machine presets & performance, idempotency, metadata & progress tracking, frontend triggering with React hooks, large payloads, hidden tasks, logging & tracing, usage monitoring, and run management. Use when implementing production-grade workflows, managing task concurrency, ensuring idempotency for critical operations, tracking progress, or optimizing task performance and resource usage.
---
