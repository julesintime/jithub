...
description: Comprehensive guide to Trigger.dev v4 scheduled tasks (cron jobs) including defining scheduled tasks, attaching schedules declaratively or imperatively, cron syntax, dynamic/multi-tenant scheduling, SDK management (create, update, delete, activate, deactivate), and dashboard usage. Use when implementing recurring workflows, setting up cron jobs, creating per-user scheduled tasks, or managing schedules programmatically. For one-off delayed tasks, use the delay option instead.
---
