---
name: trigger-basic
description: Foundational Trigger.dev v4 task patterns including basic tasks, schema validation with Zod, scheduled tasks (cron), task triggering patterns, and waits. Use when implementing basic Trigger.dev workflows, creating tasks with validation, setting up scheduled jobs, or working with task orchestration and timing patterns. MUST use `@trigger.dev/sdk` (v4), NEVER `client.defineJob`.
---
